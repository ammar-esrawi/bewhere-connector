...
myApp.controller('swDashboardCtrl', function($scope,  wsClient, httpClient, $routeParams, constants) {
    ...
    vm.waterConductivityFormatData = function(data){
        return data.latest.water_conductivity;
    }
    
    vm.oxydoReductioPotentialFormatData = function(data){
        return data.latest.oxidation_reduction_potential;
    }

    vm.dissolvedOxygenFormatData = function(data){
        return data.latest.dissolved_oxygen;
    }
